...
- `scripts/review_layout_objects_moondream.py` supports Moondream cloud and local Photon/Kestrel mode. `scripts/benchmark_moondream_local.py` records local edge viability; on this machine it wrote skipped reports because the NVIDIA MX330 has only ~2GB free VRAM, below the safe local-Moondream threshold.
