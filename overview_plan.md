...
- **Tier 1 architecture Mermaid landed:** `README.md` and `docs/architecture/README.md` now show the architecture as a Mermaid flowchart instead of a generated architecture PNG/HTML, making the docs easier to review and edit in GitHub.
