...
| Hosting | Render backend (`cafetwin-backend-tier1`, pinned to `tier_1`, dependencies installed by `uv sync --no-install-project`) + static frontend served as flat HTML |
